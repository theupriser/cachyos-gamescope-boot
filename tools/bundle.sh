...
#   tools/bundle.sh [output]      (default: dist/setup-gamescope-boot.sh)
#
...

{
    ...
    echo "# Single-file build ($version), generated by tools/bundle.sh - edit the"
    echo "# sources in the repository instead: https://github.com/theupriser/cachyos-gamescope-boot"
    echo
    for lib in $libs; do
        echo "# ----- lib/$lib.sh -----"
